...
class TestCategoryA:
    ...
    def test_syntax_error_beats_timeout_keyword(self) -> None:
        ...
        stderr = "# wait_for_selector: Timeout 5000ms exceeded\nSyntaxError: invalid syntax\n"
        assert classify_error(stderr) == ErrorCategory.A
...
class TestCategoryC:
    ...
    def test_net_err_in_non_goto_context_still_C(self) -> None:
        ...
        stderr = "patchright._impl._errors.Error: Page.click: net::ERR_CONNECTION_RESET\n"
        assert classify_error(stderr) == ErrorCategory.C
...
class TestCategoryG:
    ...
    def test_schema_error_with_empty_stderr(self) -> None:
        assert (
            classify_error(
                "  \n",
                exit_code=0,
                schema_error="Missing field: price",
            )
            == ErrorCategory.G
        )
    ...
    def test_schema_error_none_exit(self) -> None:
        ...
        assert (
            classify_error(
                "",
                exit_code=None,
                schema_error="Wrong type for field 'price'",
            )
            == ErrorCategory.G
        )
    ...
    def test_crash_plus_schema_error_is_crash(self) -> None:
        ...
        result = classify_error(
            stderr,
            exit_code=1,
            schema_error="Expected at least 5 items",
        )
...
class TestReviewEdgeCases:
    ...
    def test_navigation_timeout_with_e_pattern_in_call_log_is_c(self) -> None:
        ...
        stderr = "Page.goto: Timeout 30000ms exceeded.\nCall log:\n  - element is not visible\n"
