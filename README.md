...
scraper = Scraper(
    ...
    schema=Items({"name": str, "price": float}, min_items=10),
...
schema = List({"title": str, "price": float}, min_items=10)
```
...
result.script_generated  # True = freshly generated, False = ran from saved script
